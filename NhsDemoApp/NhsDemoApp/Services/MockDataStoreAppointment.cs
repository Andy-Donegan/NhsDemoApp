    ...
    public class MockDataStoreAppointment : IDataStoreAppointment<Appointment>
    {
        ...
        public MockDataStoreAppointment()
        {
            ...
            for (int i = 0; i < contactList.Length; i++)
            {
                ...
                appointments.Add(new Appointment { Id = Guid.NewGuid().ToString(), DueTime = dueTime.AddHours(i), Contact = contactList[i], ArrivalTime = null, DepartureTime= null, IsCompleted = randomBool, IsLate = false, OnSite = false , User = "", Organisation = "", TimesRequired = true, Latitude = 0, Longitude = 0 });
            };
        }
